#!/usr/bin/env python3
"""
Convert PNG image to LVGL RGB565 C array format for Flash Screen background.

Input: assets/boot/flashscreen_320x480.png (320x480 pixels)
Output: components/sx_assets/generated/flashscreen_img.c/.h
"""
...
INPUT_PNG = ASSETS_DIR / "flashscreen_320x480.png"
OUTPUT_C = GENERATED_DIR / "flashscreen_img.c"
OUTPUT_H = GENERATED_DIR / "flashscreen_img.h"
...
def convert_png_to_rgb565(png_path):
    ...
    if img.size != (EXPECTED_WIDTH, EXPECTED_HEIGHT):
        print(f"  - Image size is {img.size}, resizing to ({EXPECTED_WIDTH}, {EXPECTED_HEIGHT})...")
...
def generate_c_file(data):
    """Generate flashscreen_img.c file."""
    # Calculate size
    data_size = len(data)
 ...
 * Generated from: assets/boot/flashscreen_320x480.png
...
static const uint8_t flashscreen_img_map[] = {{
"""
...
const lv_img_dsc_t flashscreen_img = {{
    .header = {{
        .w = {EXPECTED_WIDTH},
        .h = {EXPECTED_HEIGHT},
...
def generate_h_file():
    """Generate flashscreen_img.h file."""
    h_content = f"""/*
 * Auto-generated file - DO NOT EDIT
 * Generated from: assets/boot/flashscreen_320x480.png
 */
...
// Flash screen background image (320x480 BGR565 for ST7796)
extern const lv_img_dsc_t flashscreen_img;
